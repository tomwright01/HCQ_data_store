...
-- Step 5: Create the Visits table (with MERCI, FAF, OCT, and VF)
...
-- Insert sample visits (FAF, OCT, VF, and MERCI included)
INSERT INTO Visits (patient_id, visit_date, visit_notes, faf_test_id, faf_eye, image_number, oct_test_id, oct_eye, oct_image_number, vf_test_id, vf_eye, vf_image_number, merci_rating_left_eye, merci_rating_right_eye)
VALUES 
(1, '2023-06-01', 'Routine check-up, no concerns noted', 123, 'OD', 555, 201, 'OD', 801, 301, 'OD', 901, 10, 12),
(2, '2023-06-10', 'Follow-up for RA, increased symptoms', 124, 'OS', 556, 202, 'OS', 802, 302, 'OS', 902, 15, 14),
(3, '2023-07-01', 'New patient, first consultation', 125, 'OD', 557, 203, 'OD', 803, 303, 'OD', 903, 8, 10),
(4, '2023-07-15', 'Sjorgens diagnosis confirmed, prescribed treatment', 126, 'OS', 558, 204, 'OS', 804, 304, 'OS', 904, 18, 17);

-- Query: View visit with patient, MERCI, FAF, OCT, and VF info
SELECT
    v.visit_id,
    v.visit_date,
    v.visit_notes,
...
-- Query: Check missing visit data (updated for FAF, OCT, and VF)
...
-- Step 5: Create the Visits table (with MERCI, FAF, and OCT)
CREATE TABLE IF NOT EXISTS Visits (
    visit_id INT AUTO_INCREMENT PRIMARY KEY,
    patient_id INT,
    visit_date DATE NOT NULL,
...
-- Insert sample visits (FAF, OCT, and MERCI included)
INSERT INTO Visits (patient_id, visit_date, visit_notes, faf_test_id, faf_eye, image_number, oct_test_id, oct_eye, oct_image_number, merci_rating_left_eye, merci_rating_right_eye)
VALUES 
(1, '2023-06-01', 'Routine check-up, no concerns noted', 123, 'OD', 555, 201, 'OD', 801, 10, 12),
(2, '2023-06-10', 'Follow-up for RA, increased symptoms', 124, 'OS', 556, 202, 'OS', 802, 15, 14),
(3, '2023-07-01', 'New patient, first consultation', 125, 'OD', 557, 203, 'OD', 803, 8, 10),
(4, '2023-07-15', 'Sjorgens diagnosis confirmed, prescribed treatment', 126, 'OS', 558, 204, 'OS', 804, 18, 17);

-- Query: View visit with patient, MERCI, FAF, and OCT info
SELECT
    v.visit_id,
    v.visit_date,
    v.visit_notes,
...
-- Query: Check missing visit data (updated for both FAF and OCT)
SELECT v.visit_id, v.patient_id, v.visit_date, v.visit_notes,
    CASE
        WHEN visit_date IS NULL THEN 'Visit date missing'
        WHEN visit_notes IS NULL THEN 'Visit notes missing'
...
-- Step 5: Create the Visits table (MERCI scores added here)
CREATE TABLE IF NOT EXISTS Visits (
    visit_id INT AUTO_INCREMENT PRIMARY KEY,
    patient_id INT,
    visit_date DATE NOT NULL,
...
-- Insert sample visits (MERCI scores included)
INSERT INTO Visits (patient_id, visit_date, visit_notes, faf_test_id, faf_eye, image_number, merci_rating_left_eye, merci_rating_right_eye)
VALUES 
(1, '2023-06-01', 'Routine check-up, no concerns noted', 123, 'OD', 555, 10, 12),
(2, '2023-06-10', 'Follow-up for RA, increased symptoms', 124, 'OS', 556, 15, 14),
(3, '2023-07-01', 'New patient, first consultation', 125, 'OD', 557, 8, 10),
(4, '2023-07-15', 'Sjorgens diagnosis confirmed, prescribed treatment', 126, 'OS', 558, 18, 17);

-- Query: View visit with patient and MERCI info
SELECT
    v.visit_id,
    v.visit_date,
    v.visit_notes,
...
-- Query: Check missing visit data
SELECT v.visit_id, v.patient_id, v.visit_date, v.visit_notes,
    CASE
        WHEN visit_date IS NULL THEN 'Visit date missing'
        WHEN visit_notes IS NULL THEN 'Visit notes missing'
