...
$fieldName = strtolower($test_type) . '_reference_' . $eye; // oct_reference_OD|OS
...
(() => {
  ...
  btnDl.addEventListener('click', () => {
    ...
    a.href = baseUrl;
    a.download = "OCT_<?= htmlspecialchars($patient_id) ?>_<?= htmlspecialchars($eye) ?>_<?= htmlspecialchars($test_date ?? 'date') ?>.pdf";
